 ...
 */
class local_report_dt extends base {
    ...
    protected function get_default_entity_title(): lang_string {
        return new lang_string('local_report_dt', 'local_ard_report');
    }
...
*/		
    ...
    protected function get_all_columns(): array {
        ...
        $reportalias = $this->get_table_alias('local_report_dt');
    ...
    protected function get_all_filters(): array {
        $entityalias = $this->get_table_alias('local_report_dt');
