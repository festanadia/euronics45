 ...
 */
class local_report_trasversale extends base {
    ...
    protected function get_default_entity_title(): lang_string {
        return new lang_string('local_report_trasversale', 'local_ard_report');
    }
...
*/		
    ...
    protected function get_all_columns(): array {
        ...
        $reportalias = $this->get_table_alias('local_report_trasversale');
        ...
        $columns[] = (new column(
            'nome',
            new lang_string('nome', 'local_ard_report'),
            $this->get_entity_name()
        ))
            ->add_joins($this->get_joins())
            ->set_type(column::TYPE_TEXT)
            ->add_field("{$reportalias}.nome")
            ->add_callback(static function(?string $name, stdClass $reportalias): string { 
                return format_string($reportalias->nome);
            })			
            ->set_is_sortable(true);
        ...
        $columns[] = (new column(
            'cognome',
            new lang_string('cognome', 'local_ard_report'),
            $this->get_entity_name()
        ))
            ->add_joins($this->get_joins())
            ->set_type(column::TYPE_TEXT)
            ->add_field("{$reportalias}.cognome")
            ->add_callback(static function(?string $name, stdClass $reportalias): string { 
                return format_string($reportalias->cognome);
            })			
            ->set_is_sortable(true);			
        ...
        // DataCompletamentoPerCorso
        $columns[] = (new column(
            'datacompletamentopercorso',
            new lang_string('datacompletamentopercorso', 'local_ard_report'),
            $this->get_entity_name()
        ))
            ->add_joins($this->get_joins())
            ->set_type(column::TYPE_TEXT)
            ->add_field("{$reportalias}.datacompletamentopercorso")
            ->add_callback(static function(?string $name, stdClass $reportalias): string { 
                return format_string($reportalias->datacompletamentopercorso);
            })			
            ->set_is_sortable(true);
        ...
        $columns[] = (new column(
            'sommapunteggi',
            new lang_string('sommapunteggi', 'local_ard_report'),
            $this->get_entity_name()
        ))
            ->add_joins($this->get_joins())
            ->set_type(column::TYPE_TEXT)
            ->add_field("{$reportalias}.sommapunteggi")
            ->add_callback(static function(?string $name, stdClass $reportalias): string { 
                return format_string($reportalias->sommapunteggi);
            })			
            ->set_is_sortable(true);
        ...
        $columns[] = (new column(
            'statopercorso',
            new lang_string('statopercorso', 'local_ard_report'),
            $this->get_entity_name()
        ))
            ->add_joins($this->get_joins())
            ->set_type(column::TYPE_TEXT)
            ->add_field("{$reportalias}.statopercorso")
            ->add_callback(static function(?string $name, stdClass $reportalias): string { 
                return format_string($reportalias->statopercorso);
            })			
            ->set_is_sortable(true);
    ...
    protected function get_all_filters(): array {
        $entityalias = $this->get_table_alias('local_report_trasversale');
