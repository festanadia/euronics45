...
class mod_certificate_mod_form extends moodleform_mod {
    ...
    function definition() {
        ...
        $mform->addElement('text', 'scormname', get_string('scormname', 'certificate'), array('size'=>'5', 'maxlength' => '255'));
        $mform->setType('scormname', PARAM_TEXT);
        $mform->addHelpButton('scormname', 'scormname', 'certificate');
