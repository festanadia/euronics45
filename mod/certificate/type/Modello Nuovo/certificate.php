...
if($result) {
  ...
  certificate_print_text($pdf, $x, $y+5, 'C', 'Helvetica', 'B', 18, $personaldata1,$txtareawdth);
 certificate_print_text($pdf, $x, $y+14, 'C', 'Helvetica', 'B', 18, $personaldata,$txtareawdth);
    $codicefiscale = 'CF: '.$USER->codicefiscale;
    certificate_print_text($pdf, $x, $y+21, 'C', 'Helvetica', 'B', 16, $codicefiscale,$txtareawdth);
