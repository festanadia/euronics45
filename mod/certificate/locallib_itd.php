...
function getUser($idUser){
    global $DB;
    $userrec= $DB->get_record('user',array('id'=>$idUser));
    return $userrec;
 ...
 */
function certificate_save_pdf($pdf, $certrecordid, $filename, $contextid,$iduser) {
...
function certificate_get_issue($course, $user, $certificate, $cm) {
    ...
    if ($certissue = $DB->get_record('certificate_issues', array('userid' => $user, 'certificateid' => $certificate->id))) {
        return $certissue;
    }
