@enrol @enrol_link
Feature: Users can auto-enrol themself in courses where link enrolment is allowed
  ...
  @javascript
  Scenario: link-enrolment enabled as guest
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I add "link enrolment" enrolment method with:
  ...
  Scenario: link-enrolment enabled
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage
    When I add "link enrolment" enrolment method with:
      | Custom instance name | Test student enrolment |
    And I log out
  ...
  Scenario: link-enrolment enabled requiring an enrolment key
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage
    When I add "link enrolment" enrolment method with:
      | Custom instance name | Test student enrolment |
  ...
  Scenario: link-enrolment disabled
    Given I log in as "student1"
    When I am on "Course 1" course homepage
    Then I should see "You cannot enrol yourself in this course"

  Scenario: linkf-enrolment enabled requiring a group enrolment key
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage
    When I add "link enrolment" enrolment method with:
      | Custom instance name | Test student enrolment |
  ...
  @javascript
  Scenario: Edit a link-enrolled user's enrolment from the course participants page
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage
    When I add "link enrolment" enrolment method with:
      | Custom instance name | Test student enrolment |
  ...
  @javascript
  Scenario: Unenrol a link-enrolled student from the course participants page
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage
    When I add "link enrolment" enrolment method with:
      | Custom instance name | Test student enrolment |
