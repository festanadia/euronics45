...
class frontend extends \core_availability\frontend {
    ...
    protected function get_javascript_strings() {
        return array('option_complete', 'option_fail', 'option_incomplete', 'option_pass',
                'label_cm', 'label_completion','ajaxerror', 'direction_none', 'direction_before', 'direction_from', 'direction_until',
                'direction_label');
    }
    ...
    protected function get_javascript_init_params($course, \cm_info $cm = null,
        ...
        foreach ($fields as $field => $options) {
            ...
            foreach ($options as $key => $value) {
                ...
                //$htm .= '<option value="'.$value.'"'.$selected.'>'.$value.'</option>';
        ...
        return array($html,$time,$this->cacheinitparams[0]);
    }
