 ...
 */
$string['pluginname'] = 'Riprendi da dove avevi lasciato';
...
$string['aelrecentlyaccessedcourses:myaddinstance'] = 'Add a new recently accessed courses block to Dashboard';
$string['nocourses'] = 'No recent courses';
$string['aelmsgwelcome'] = 'Bentornato! Riprendi da dove avevi lasciato';
