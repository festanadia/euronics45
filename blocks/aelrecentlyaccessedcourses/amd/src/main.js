 ...
 *
 * @module     block_aelrecentlyaccessedcourses/main
...
define(
    ...
    function(
        ...
        // Constants.
        var NUM_COURSES_TOTAL = 1;
        var SELECTORS = {
            BLOCK_CONTAINER: '[data-region="aelrecentlyaccessedcourses"]',
        ...
        var renderAllCourses = function(courses) {
            ...
            var promises = courses.map(function(course) {
                ...
                return Templates.render('block_aelrecentlyaccessedcourses/course-card', course);
            });
         ...
         *
         * @param {object} root The root element for the aelrecentlyaccessedcourses block.
         */
        ...
        const getLastAccessedCoursesWithCustomField = (courseid) => {
            const args = {};

            const request = {
            methodname: 'ael_course_get_courses',
                args: {
        ...
        return {
            init: init, getLastAccessedCoursesWithCustomField: getLastAccessedCoursesWithCustomField
        };
    });
