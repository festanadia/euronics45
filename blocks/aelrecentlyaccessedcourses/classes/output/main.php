 ...
 */
namespace block_aelrecentlyaccessedcourses\output;
...
class main implements renderable, templatable {
    ...
    public function export_for_template(renderer_base $output) {
        ...
        $nocoursesurl = $output->image_url('courses', 'block_aelrecentlyaccessedcourses')->out(false);
        $config = get_config('block_aelrecentlyaccessedcourses');
