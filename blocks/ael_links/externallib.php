...
class ael_links_external extends external_api {
   ...
   public static function get_all_courses_parameters() {
       return new external_function_parameters(
         array('typeEnrol' => new external_value(PARAM_TEXT, 'optional param'),
               ...
               'customfieldvalue' => new external_value(PARAM_TEXT, 'optional param'),
         ) 
       );
    }
    ...
    public static function get_all_courses($typeEnrol,$customfield,$customfieldvalue) {
        ...
        $courses = \mycourse_enrollment\mycourse_custom_enrollment::get_course_with_type_enrollment_link($USER->id ,  $typeEnrol);
        $coursesEvidence = [];
        ...
        if ($customfields) {
            foreach ($customfields as $data) {
                if($data->get_shortname() == $customfield && !empty($value)){
                    return  strtoupper($data->get_value()) ==  strtoupper($value);
                }
