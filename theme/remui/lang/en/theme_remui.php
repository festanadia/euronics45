...
$string['hideheadermydashboard'] = 'Hide Header MyDashboard';
$string['hideheadermydashboarddesc'] = 'If want to show header only local launch in broswer localStorage.setItem("hideheader",false)';
// License Settings.
$string['licensenotactive'] = '<strong>Alert!</strong> License is not activated , please <strong>activate</strong> the license in RemUI settings.';
...
$string['categoryfilter'] = 'Categoria';
$string['duratafilter'] = 'Durata';
$string['priorityfilter'] = 'Priorità';
$string['statofilter'] = 'Stato';
$string['brandfilter'] = 'Brand';
$string['abbiamotrovato'] = 'Abbiamo trovato';
$string['risultati'] = 'risultati';
$string['mostradipiu'] = 'Mostra di più';
$string['concluso'] = 'Concluso';
$string['catalogocorsi'] = 'Catalogo corsi';
// Plural and Singular.
...
$string['isprincipalcourse'] = 'Reparto principale';
