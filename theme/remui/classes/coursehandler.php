...
//            $coursesarray[$count]["myprogress"] = mycourse_custom_info::percentual_progress($course, $USER->id);
            $coursesarray[$count]["courseurl"] = $CFG->wwwroot."/course/view.php?id=".$course->id;
//            if (mycourse_custom_info::isPrincipale($course->id, $USER->id)){
//                $coursesarray[$count]["isPrincipal"] = true;
//            }
         //   $progress = \core_completion\progress::get_course_progress_percentage($course, $user_id);
         //   if( $progress == 100 ) $coursesarray[$count]["isConcluso"] = 1;
            ...
            foreach($courseinfo['customfields'] as $name){
                ...
                {
                    $coursesarray[$count]['shortname'] = $name['value'];
                }
            }
...
// NF lo sposto qui così lo calcolo solo se l'utente è iscritto
$coursesarray[$count]["myprogress"] = mycourse_custom_info::percentual_progress($course, $USER->id);		
$coursesarray[$count]["progress"] = $coursesarray[$count]["myprogress"];		
                ...
                if ($completion->is_enabled()) {
                    ...
                    if (!is_null($percentage)) {
                        ...
                        if ($percentage == 100) {
                            ...
                            $coursesarray[$count]["percentage"]  = "25";
