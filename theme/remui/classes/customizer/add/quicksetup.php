    ...
    private function add_color_schemes() {
        ...
        $pallets = [[
            ...
            'preset' => [
                ...
                // Button - Primary.
                'primarybuttonbg' => '#1a408c',
                'primarybuttonbghover' => Color::shade('#1a408c', 20),
                'primarybuttonborder' => '#1a408c',
                'primarybuttonborderhover' => Color::shade('#1a408c', 20),
                'primarybuttontext' => '#FFFFFF',
                'primarybuttonicon' => '#FFFFFF',

                // Button - Secondary.
                'secondarybuttontext' => '#1a408c',
                'secondarybuttontexthover' => Color::shade('#1a408c', 20),
                'secondarybuttonborder' => '#1a408c',
                'secondarybuttonborderhover' => Color::shade('#1a408c', 20),
                'secondarybuttonicon' => '#1a408c',
                'secondarybuttoniconhover' => Color::shade('#1a408c', 20),
                ...
                'linkhover' => '#0041C7',
                'headertext' => '#63718C',
                'headertexthover' => '#1a408c',
                'headertextactive' => '#1a408c',
                'footertext' => '#FFFFFF',
